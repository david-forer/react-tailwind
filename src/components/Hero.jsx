            ...
            <div className="flex items-center justify-center overflow-y-hidden">
                <div className="2xl:mx-auto 2xl:container xl:py-24 lg:py-12 py-8 xl:px-20 px-6 flex lg:flex-row flex-col-reverse items-strech justify-center">
                    <div className="lg:w-5/12 flex items-center lg:items-start justify-center flex-col">
                        ...
                        <Link to={`/products`}>
                            <button className="dark:bg-white dark:hover:bg-red-300 dark:text-red-800 md:w-auto w-full px-8 py-4 focus:outline-none border border-gray-800 hover:bg-gray-700 bg-red-600 text-base focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 leading-none text-gray-50">Explore collection</button></Link>
                        </div>
                    </div>
