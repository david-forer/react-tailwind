...
export default function Contact() {
    return (
        <div>
            <div className="py-12 2xl:px-40 px-40 xl:mx-auto 3xl:container bg-gray-50">
                <div className="flex flex-col items-center">
                    <h1 className="text-4xl font-semibold text-gray-800 text-center">Contact us</h1>
                    <p className="text-base leading-normal text-gray-600 mt-5 text-center md:w-3/5">We believe customer service starts with you being able to get a hold of us. It is important that your questions in a timely fashion so we promise to respond by the end of the next business day at the latest.</p>
                    ...
                    <div className="container mx-auto grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 mt-10 gap-6">
                        ...
                        <div className="bg-white border rounded-md border-gray-200 h-64 flex flex-col items-center ">
                            ...
                            <p className="text-base mt-4 leading-4 text-center text-gray-600">customerservice@gmail.com</p>
                        </div>
                        <div className="bg-white border rounded-md border-gray-200 h-64 flex flex-col items-center ">
                            ...
                            <p className="text-base mt-4 leading-6 text-center text-gray-600 w-48">13420 -Main Street, Lake Geneva, NY (91342) </p>
                        </div>
                    </div>
                </div>
            </div>
